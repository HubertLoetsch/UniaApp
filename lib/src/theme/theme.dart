...
class AppTheme {
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    backgroundColor: DarkColor.background,//Hintergrund
    primaryColor: Colors.red,//Kategorie
    ...
    iconTheme: IconThemeData(color: Colors.red),//Icon unter Profil
    bottomAppBarColor: DarkColor.lightblack,//apppar unten
